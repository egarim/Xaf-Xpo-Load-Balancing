...
namespace XafXpoLoadBalancing.Module
{
    ...
    /// </summary>
    public class BitXpoLoadBalancingMultipleReadSingleWriteProvider : DataStoreForkMultipleReadersSingleWriter
    {
        public BitXpoLoadBalancingMultipleReadSingleWriteProvider(IDataStore changesProvider, params IDataStore[] readProviders) : base(changesProvider, readProviders)
        {
        }
